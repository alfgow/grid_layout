function setCurrentTimePosition() {
	...
	const $calendar = document.querySelector(".calendarWeek");
	...
	calendarInlineSize =
		calendarInlineSize - calendarTimezoneCellInlineSize;
	...
	$currentTime.style.left = `${
		cellInlineSize * currentDay +
		calendarTimezoneCellInlineSize +
		24
	}px`;
}
